...
class ComboBox(ttk.Frame):
    ...
    def __init__(self, master, title, values, width= 40) -> None:
        super().__init__(master)     
        self.selected_value = None
        label = ttk.Label(self, text=title)
        label.grid(row=0, column=0, sticky=tk.W, pady=4, padx=1)
        ...
        self.combo.grid(row=0, column=1, sticky=tk.N + tk.S + tk.E + tk.W)
        #self.combo.bind('<Configure>', combo_configure)
