...
- использую отдельный поток для запуска ASTRA
- рефакториг модулей WorkSpace, Kernel и WSL
- рефакторинг класса App. Скрываю главное окно и искользую новое окно Toplevel для главного окна
...
- начал делать рисование равновесия плазмы
- сделел обрезание спектров по нижней границе для Scatter и 2D спектров
- сделал оконное прорежевание двемерных спектров. 
- теперь использую формат nml 
- пофискил перехват ошибок при считывании неправильного спектра
